...
## ------
В приложении добавил Checkbox, чтобы отмечать задачу как выполненную. Для добавление задачи использовал Floating Action Button. Для удаления задачи использовал Dismissible — нужно сделать свайп справа налево.
